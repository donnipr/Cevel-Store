                        ...
                        <?php $no=1; ?>
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" last">
                                ...
                                <a href="{{ url('del', $key->id) }}" onclick="return confirm('Are you sure want to delete data selected?')" class="btn btn-danger fa fa-trash" data-toggle="tooltip" data-placement="right" title="" data-original-title="Delete"><i class=""></i></a>
                            </td>
                          </tr>
                          @endforeach
                        </tbody>
