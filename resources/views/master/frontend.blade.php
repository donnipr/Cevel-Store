        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="" class="site_title"><i class="fa fa-github"></i> <span class="greentea">Dashboard</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href=""><i class="fa fa-home"></i> Home <span class="fa fa-angle-double-right"></span></a>
                  </li>
                  <li><a href=""><i class="fa fa-shopping-cart"></i> Shoping Chart <span class="fa fa-angle-double-right"></span></a>
                  </li>
                  </li>
                </ul>
              </div>
