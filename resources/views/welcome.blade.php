   ...
   <div class="header-bottom">
    <div class="wrap">
        ...
        <ul class="megamenu skyblue">
            ...
            <li class="grid"><a class="color12" href="">All Products</a></li>
            <li class="active grid"><a class="color12" href="">T-shrit</a></li>
            <li class="active grid"><a class="color12" href="">Jackets</a></li>
            <li class="active grid"><a class="color12" href="">Bags</a></li>
                         ...
                         <ul class="list">
                          <li>
                            ...
                            <ul class="icon1 sub-icon1 profile_img">
                              <li><a class="active-icon c1" href="{{ route('cart.edit', $key->id) }}">Add To Bag </a>
                              </li>
                             </ul>
                           </li>
                         </ul>
