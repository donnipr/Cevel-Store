...
<html lang="en">
  <head>
    ...
    <title>Laravel | Admin area </title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="" class="site_title"><i class="fa fa-stack-overflow"></i> <span class="greentea">Admin Area</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-angle-double-right"></span></a>
                  </li>
                  <li><a href="{{ route('categorys.index') }}"><i class="fa fa-share-alt"></i> Category Product <span class="fa fa-angle-double-right"></span></a>
                  </li>
                  <li><a href="{{ route('product.index') }}"><i class="fa fa-shopping-cart"></i> Product <span class="fa fa-angle-double-right"></span></a>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="{{asset('backend/production/images/img.jpg')}}" alt="">auth
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li>
                    <a href="{{ url('/logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="fa fa-sign-out pull-right">Sign out</a>
                    <form id="logout-form" action="{{ url('/logout') }}" method="POST" style="display: none;">{{ csrf_field() }}
                    </form></li>
                  </ul>
                </li>
                <li class="pull-right"><a href="{!! url('') !!}" target="_blank" data-toggle="tooltip" data-placement="left" title="" data-original-title="View Site"><i class="fa fa-external-link"></i></a></li>
